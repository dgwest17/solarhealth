...
export const TOOLTIPS = {
  ...
  annualProduction: 'How much the system generates per year (kWh). Best source: the monitoring app (Enphase/SolarEdge/Tesla) 12-month total. Can also take System Size and divide by (.6 for pure south facing, .7 for a mixture, .8 for no south, .9 for really bad sun exposure',
